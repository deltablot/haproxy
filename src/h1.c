 ...
 */
int h1_headers_to_hdr_list(char *start, const char *stop, struct http_hdr *hdr,
                           unsigned int hdr_num, struct h1m *h1m,
                           union h1_sl *slp) {
...
try_again:
  ...
  http_msg_rqbefore:
    ...
    if (unlikely(*ptr == '\n'))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rqbefore, http_msg_ood, state,
                             H1_MSG_RQBEFORE);
    EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rqbefore_cr, http_msg_ood, state,
                           H1_MSG_RQBEFORE_CR);
    /* stop here */
  ...
  http_msg_rqmeth:
    if (likely(HTTP_IS_TOKEN(*ptr)))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rqmeth, http_msg_ood, state,
                             H1_MSG_RQMETH);

    if (likely(HTTP_IS_SPHT(*ptr))) {
      sl.rq.m.len = ptr - sl.rq.m.ptr;
      sl.rq.meth = find_http_meth(start, sl.rq.m.len);
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rqmeth_sp, http_msg_ood, state,
                             H1_MSG_RQMETH_SP);
    }
  ...
  http_msg_rquri2:
    if (likely((unsigned char)(*ptr - 33) <= 93)) /* 33 to 126 included */
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rquri2, http_msg_ood, state,
                             H1_MSG_RQURI);

    if (likely(HTTP_IS_SPHT(*ptr))) {
      sl.rq.u.len = ptr - sl.rq.u.ptr;
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rquri_sp, http_msg_ood, state,
                             H1_MSG_RQURI_SP);
    }
    if (likely((unsigned char)*ptr >= 128)) {
      ...
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rquri, http_msg_ood, state,
                             H1_MSG_RQURI);
    }
  ...
  http_msg_rqver:
    if (likely(HTTP_IS_VER_TOKEN(*ptr)))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rqver, http_msg_ood, state,
                             H1_MSG_RQVER);
    ...
    http_msg_rqline_eol:
      ...
      sol = ptr - start;
      if (likely(*ptr == '\r'))
        EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rqline_end, http_msg_ood,
                               state, H1_MSG_RQLINE_END);
  ...
  http_msg_rqline_end:
    ...
    EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_first, http_msg_ood, state,
                           H1_MSG_HDR_FIRST);
    /* stop here */
  ...
  http_msg_rpbefore:
    ...
    if (unlikely(*ptr == '\n'))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpbefore, http_msg_ood, state,
                             H1_MSG_RPBEFORE);
    EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpbefore_cr, http_msg_ood, state,
                           H1_MSG_RPBEFORE_CR);
    /* stop here */
  ...
  http_msg_rpver:
    if (likely(HTTP_IS_VER_TOKEN(*ptr)))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpver, http_msg_ood, state,
                             H1_MSG_RPVER);
    ...
    if (likely(HTTP_IS_SPHT(*ptr))) {
      ...
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpver_sp, http_msg_ood, state,
                             H1_MSG_RPVER_SP);
    }
    state = H1_MSG_RPVER;
    goto http_msg_invalid;
  ...
  http_msg_rpcode:
    if (likely(HTTP_IS_DIGIT(*ptr))) {
      ...
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpcode, http_msg_ood, state,
                             H1_MSG_RPCODE);
    }
    ...
    if (likely(HTTP_IS_SPHT(*ptr))) {
      ...
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpcode_sp, http_msg_ood, state,
                             H1_MSG_RPCODE_SP);
    }
  ...
  http_msg_rpreason:
    if (likely(!HTTP_IS_CRLF(*ptr)))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpreason, http_msg_ood, state,
                             H1_MSG_RPREASON);
  ...
  http_msg_rpline_eol:
    ...
    sol = ptr - start;
    if (likely(*ptr == '\r'))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_rpline_end, http_msg_ood, state,
                             H1_MSG_RPLINE_END);
  ...
  http_msg_hdr_first:
    ...
    if (likely(*ptr == '\r'))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_last_lf, http_msg_ood, state,
                             H1_MSG_LAST_LF);
    goto http_msg_last_lf;
  ...
  http_msg_hdr_name:
    ...
    if (likely(HTTP_IS_TOKEN(*ptr))) {
      ...
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_name, http_msg_ood, state,
                             H1_MSG_HDR_NAME);
    }

    if (likely(*ptr == ':')) {
      col = ptr - start;
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_l1_sp, http_msg_ood, state,
                             H1_MSG_HDR_L1_SP);
    }
  ...
  http_msg_hdr_l1_sp:
    ...
    if (likely(*ptr == '\r'))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_l1_lf, http_msg_ood, state,
                             H1_MSG_HDR_L1_LF);
  ...
  http_msg_hdr_l1_lf:
    ...
    EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_l1_lws, http_msg_ood, state,
                           H1_MSG_HDR_L1_LWS);
  ...
  http_msg_hdr_val2:
    if (likely(!HTTP_IS_CRLF(*ptr)))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_val2, http_msg_ood, state,
                             H1_MSG_HDR_VAL);
     ...
     */
    if (likely(*ptr == '\r'))
      EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_l2_lf, http_msg_ood, state,
                             H1_MSG_HDR_L2_LF);
  ...
  http_msg_hdr_l2_lf:
    ...
    EAT_AND_JUMP_OR_RETURN(ptr, end, http_msg_hdr_l2_lws, http_msg_ood, state,
                           H1_MSG_HDR_L2_LWS);
  ...
  http_msg_complete_header:
    ...
    if (likely(!skip_update)) {
      ...
      do {
        ...
        } else if (!(h1m->flags & (H1_MF_HDRS_ONLY | H1_MF_RESP)) &&
                   isteqi(n, ist("host"))) {
          if (host_idx == -1) {
...
restart:
  h1m->flags &= ~(H1_MF_VER_11 | H1_MF_CLEN | H1_MF_XFER_ENC | H1_MF_CHNK |
                  H1_MF_CONN_KAL | H1_MF_CONN_CLO | H1_MF_CONN_UPG);
 ...
 */
int h1_measure_trailers(const struct buffer *buf, unsigned int ofs,
                        unsigned int max) {
