...
char *pat_match_names[PAT_MATCH_NUM] = {
    [PAT_MATCH_FOUND] = "found", [PAT_MATCH_BOOL] = "bool",
    [PAT_MATCH_INT] = "int",     [PAT_MATCH_IP] = "ip",
    [PAT_MATCH_BIN] = "bin",     [PAT_MATCH_LEN] = "len",
    [PAT_MATCH_STR] = "str",     [PAT_MATCH_BEG] = "beg",
    [PAT_MATCH_SUB] = "sub",     [PAT_MATCH_DIR] = "dir",
    [PAT_MATCH_DOM] = "dom",     [PAT_MATCH_END] = "end",
    [PAT_MATCH_REG] = "reg",     [PAT_MATCH_REGM] = "regm",
};

int (*pat_parse_fcts[PAT_MATCH_NUM])(const char *, struct pattern *, int,
                                     char **) = {
    [PAT_MATCH_FOUND] = pat_parse_nothing, [PAT_MATCH_BOOL] = pat_parse_nothing,
    [PAT_MATCH_INT] = pat_parse_int,       [PAT_MATCH_IP] = pat_parse_ip,
    [PAT_MATCH_BIN] = pat_parse_bin,       [PAT_MATCH_LEN] = pat_parse_int,
    [PAT_MATCH_STR] = pat_parse_str,       [PAT_MATCH_BEG] = pat_parse_str,
    [PAT_MATCH_SUB] = pat_parse_str,       [PAT_MATCH_DIR] = pat_parse_str,
    [PAT_MATCH_DOM] = pat_parse_str,       [PAT_MATCH_END] = pat_parse_str,
    [PAT_MATCH_REG] = pat_parse_reg,       [PAT_MATCH_REGM] = pat_parse_reg,
};

int (*pat_index_fcts[PAT_MATCH_NUM])(struct pattern_expr *, struct pattern *,
                                     char **) = {
    [PAT_MATCH_FOUND] = pat_idx_list_val, [PAT_MATCH_BOOL] = pat_idx_list_val,
    [PAT_MATCH_INT] = pat_idx_list_val,   [PAT_MATCH_IP] = pat_idx_tree_ip,
    [PAT_MATCH_BIN] = pat_idx_list_ptr,   [PAT_MATCH_LEN] = pat_idx_list_val,
    [PAT_MATCH_STR] = pat_idx_tree_str,   [PAT_MATCH_BEG] = pat_idx_tree_pfx,
    [PAT_MATCH_SUB] = pat_idx_list_str,   [PAT_MATCH_DIR] = pat_idx_list_str,
    [PAT_MATCH_DOM] = pat_idx_list_str,   [PAT_MATCH_END] = pat_idx_list_str,
    [PAT_MATCH_REG] = pat_idx_list_reg,   [PAT_MATCH_REGM] = pat_idx_list_regm,
};

void (*pat_prune_fcts[PAT_MATCH_NUM])(struct pattern_expr *) = {
    [PAT_MATCH_FOUND] = pat_prune_gen, [PAT_MATCH_BOOL] = pat_prune_gen,
    [PAT_MATCH_INT] = pat_prune_gen,   [PAT_MATCH_IP] = pat_prune_gen,
    [PAT_MATCH_BIN] = pat_prune_gen,   [PAT_MATCH_LEN] = pat_prune_gen,
    [PAT_MATCH_STR] = pat_prune_gen,   [PAT_MATCH_BEG] = pat_prune_gen,
    [PAT_MATCH_SUB] = pat_prune_gen,   [PAT_MATCH_DIR] = pat_prune_gen,
    [PAT_MATCH_DOM] = pat_prune_gen,   [PAT_MATCH_END] = pat_prune_gen,
    [PAT_MATCH_REG] = pat_prune_gen,   [PAT_MATCH_REGM] = pat_prune_gen,
};

struct pattern *(*pat_match_fcts[PAT_MATCH_NUM])(struct sample *,
                                                 struct pattern_expr *, int) = {
    [PAT_MATCH_FOUND] = NULL,        [PAT_MATCH_BOOL] = pat_match_nothing,
    [PAT_MATCH_INT] = pat_match_int, [PAT_MATCH_IP] = pat_match_ip,
    [PAT_MATCH_BIN] = pat_match_bin, [PAT_MATCH_LEN] = pat_match_len,
    [PAT_MATCH_STR] = pat_match_str, [PAT_MATCH_BEG] = pat_match_beg,
    [PAT_MATCH_SUB] = pat_match_sub, [PAT_MATCH_DIR] = pat_match_dir,
    [PAT_MATCH_DOM] = pat_match_dom, [PAT_MATCH_END] = pat_match_end,
    [PAT_MATCH_REG] = pat_match_reg, [PAT_MATCH_REGM] = pat_match_regm,
};

/* Just used for checking configuration compatibility */
int pat_match_types[PAT_MATCH_NUM] = {
    [PAT_MATCH_FOUND] = SMP_T_SINT, [PAT_MATCH_BOOL] = SMP_T_SINT,
    [PAT_MATCH_INT] = SMP_T_SINT,   [PAT_MATCH_IP] = SMP_T_ADDR,
    [PAT_MATCH_BIN] = SMP_T_BIN,    [PAT_MATCH_LEN] = SMP_T_STR,
    [PAT_MATCH_STR] = SMP_T_STR,    [PAT_MATCH_BEG] = SMP_T_STR,
    [PAT_MATCH_SUB] = SMP_T_STR,    [PAT_MATCH_DIR] = SMP_T_STR,
    [PAT_MATCH_DOM] = SMP_T_STR,    [PAT_MATCH_END] = SMP_T_STR,
    [PAT_MATCH_REG] = SMP_T_STR,    [PAT_MATCH_REGM] = SMP_T_STR,
};
...
int pat_parse_nothing(const char *text, struct pattern *pattern, int mflags,
                      char **err) {
  return 1;
}

/* Parse a string. It is allocated and duplicated. */
int pat_parse_str(const char *text, struct pattern *pattern, int mflags,
                  char **err) {
...
int pat_parse_bin(const char *text, struct pattern *pattern, int mflags,
                  char **err) {
  struct buffer *trash;
...
int pat_parse_reg(const char *text, struct pattern *pattern, int mflags,
                  char **err) {
  pattern->ptr.str = (char *)text;
  return 1;
}
 ...
 *
 */
int pat_parse_int(const char *text, struct pattern *pattern, int mflags,
                  char **err) {
  const char *ptr = text;
 ...
 *
 */
int pat_parse_dotted_ver(const char *text, struct pattern *pattern, int mflags,
                         char **err) {
  const char *ptr = text;
  ...
  /* If the separator is the first character. */
  if (ptr == text && *(ptr + 1) != '\0') {
    if (strl2llrc_dotted(ptr + 1, strlen(ptr + 1), &pattern->val.range.max) !=
        0) {
 ...
 */
int pat_parse_ip(const char *text, struct pattern *pattern, int mflags,
                 char **err) {
...
/* always return false */
struct pattern *pat_match_nothing(struct sample *smp, struct pattern_expr *expr,
                                  int fill) {
  if (smp->data.u.sint) {
    if (fill) {
 ...
 */
struct pattern *pat_match_str(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  int icase;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if ((icase && strncasecmp(pattern->ptr.str, smp->data.u.str.area,
                              smp->data.u.str.data) == 0) ||
        (!icase && strncmp(pattern->ptr.str, smp->data.u.str.area,
                           smp->data.u.str.data) == 0)) {
      ret = pattern;
      break;
    }
...
/* NB: For two binaries buf to be identical, it is required that their lengths
 * match */
struct pattern *pat_match_bin(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
  struct pattern *ret = NULL;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if (memcmp(pattern->ptr.str, smp->data.u.str.area, smp->data.u.str.data) ==
        0) {
      ret = pattern;
      break;
    }
 ...
 * a matching array.
 */
struct pattern *pat_match_regm(struct sample *smp, struct pattern_expr *expr,
                               int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
  struct pattern *ret = NULL;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if (regex_exec_match2(pattern->ptr.reg, smp->data.u.str.area,
 ...
 */
struct pattern *pat_match_reg(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
  struct pattern *ret = NULL;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if (regex_exec2(pattern->ptr.reg, smp->data.u.str.area,
                    smp->data.u.str.data)) {
      ret = pattern;
      break;
    }
...
struct pattern *pat_match_beg(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  int icase;
  struct ebmb_node *node;
  struct pattern_tree *elt;
  ...
  if (!eb_is_empty(&expr->pattern_tree)) {
    ...
    node = ebmb_lookup_longest(&expr->pattern_tree, smp->data.u.str.area);
    if (prev)
      smp->data.u.str.area[smp->data.u.str.data] = prev;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if ((icase && strncasecmp(pattern->ptr.str, smp->data.u.str.area,
                              pattern->len) != 0) ||
        (!icase &&
         strncmp(pattern->ptr.str, smp->data.u.str.area, pattern->len) != 0))
      continue;
...
struct pattern *pat_match_end(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  int icase;
  struct pattern_list *lst;
  struct pattern *pattern;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    icase = expr->mflags & PAT_MF_IGNORE_CASE;
    if ((icase &&
         strncasecmp(pattern->ptr.str,
                     smp->data.u.str.area + smp->data.u.str.data - pattern->len,
                     pattern->len) != 0) ||
        (!icase &&
         strncmp(pattern->ptr.str,
                 smp->data.u.str.area + smp->data.u.str.data - pattern->len,
                 pattern->len) != 0))
      continue;
 ...
 */
struct pattern *pat_match_sub(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  int icase;
  char *end;
  char *c;
    ...
    if (icase) {
      for (c = smp->data.u.str.area; c <= end; c++) {
        if (tolower((unsigned char)*c) !=
            tolower((unsigned char)*pattern->ptr.str))
          continue;
 ...
 */
static int match_word(struct sample *smp, struct pattern *pattern, int mflags,
 ...
 */
struct pattern *pat_match_dir(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
 ...
 */
struct pattern *pat_match_dom(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
...
struct pattern *pat_match_int(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if ((!pattern->val.range.min_set ||
         pattern->val.range.min <= smp->data.u.sint) &&
        (!pattern->val.range.max_set ||
         smp->data.u.sint <= pattern->val.range.max))
      return pattern;
  }
  return NULL;
}

/* Checks that the length of the pattern in <test> is included between min and
 * max */
struct pattern *pat_match_len(struct sample *smp, struct pattern_expr *expr,
                              int fill) {
  struct pattern_list *lst;
  struct pattern *pattern;
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if ((!pattern->val.range.min_set ||
         pattern->val.range.min <= smp->data.u.str.data) &&
        (!pattern->val.range.max_set ||
         smp->data.u.str.data <= pattern->val.range.max))
      return pattern;
  }
  return NULL;
}

struct pattern *pat_match_ip(struct sample *smp, struct pattern_expr *expr,
                             int fill) {
  ...
  if (smp->data.type == SMP_T_IPV6) {
    ...
    if ((read_u64(&smp->data.u.ipv6.s6_addr[0]) == 0 &&
      ...
      /* Lookup an IPv4 address in the expression's pattern tree using the
  ...
  list_for_each_entry(lst, &expr->patterns, list) {
    ...
    if (((v4 ^ pattern->val.ipv4.addr.s_addr) &
         pattern->val.ipv4.mask.s_addr) == 0)
      return pattern;
  }
  return NULL;
}
...
int pat_idx_list_val(struct pattern_expr *expr, struct pattern *pat,
                     char **err) {
...
int pat_idx_list_ptr(struct pattern_expr *expr, struct pattern *pat,
                     char **err) {
  struct pattern_list *patl;
...
int pat_idx_list_str(struct pattern_expr *expr, struct pattern *pat,
                     char **err) {
  struct pattern_list *patl;
...
int pat_idx_list_reg_cap(struct pattern_expr *expr, struct pattern *pat,
                         int cap, char **err) {
  struct pattern_list *patl;
  ...
  if (!(patl->pat.ptr.reg = regex_comp(
            pat->ptr.str, !(expr->mflags & PAT_MF_IGNORE_CASE), cap, err))) {
    free(patl);
    return 0;
  }
...
int pat_idx_list_reg(struct pattern_expr *expr, struct pattern *pat,
                     char **err) {
  return pat_idx_list_reg_cap(expr, pat, 0, err);
}

int pat_idx_list_regm(struct pattern_expr *expr, struct pattern *pat,
                      char **err) {
  return pat_idx_list_reg_cap(expr, pat, 1, err);
}

int pat_idx_tree_ip(struct pattern_expr *expr, struct pattern *pat,
                    char **err) {
  unsigned int mask;
...
int pat_idx_tree_str(struct pattern_expr *expr, struct pattern *pat,
                     char **err) {
  int len;
  struct pattern_tree *node;
...
int pat_idx_tree_pfx(struct pattern_expr *expr, struct pattern *pat,
                     char **err) {
  int len;
  struct pattern_tree *node;
...
void pattern_init_head(struct pattern_head *head) { LIST_INIT(&head->head); }
...
struct pat_ref *pat_ref_lookup(const char *reference) {
  ...
  list_for_each_entry(ref, &pattern_reference,
                      list) if (ref->reference &&
                                strcmp(reference, ref->reference) ==
                                    0) return ref;
  return NULL;
}
...
void pat_ref_delete_by_ptr(struct pat_ref *ref, struct pat_ref_elt *elt) {
  ...
  list_for_each_entry_safe(bref, back, &elt->back_refs, users) {
    ...
    if (elt->list.n != &ref->head)
      LIST_ADDQ(&LIST_ELEM(elt->list.n, typeof(elt), list)->back_refs,
                &bref->users);
    bref->ref = elt->list.n;
  }
 ...
 * belongs to <ref>.
 */
int pat_ref_set_by_id(struct pat_ref *ref, struct pat_ref_elt *refelt,
                      const char *value, char **err) {
  struct pat_ref_elt *elt;
 ...
 */
struct pat_ref *pat_ref_new(const char *reference, const char *display,
                            unsigned int flags) {
  struct pat_ref *ref;
 ...
 */
struct pat_ref *pat_ref_newid(int unique_id, const char *display,
                              unsigned int flags) {
  struct pat_ref *ref;
 ...
 */
struct pat_ref_elt *pat_ref_append(struct pat_ref *ref, const char *pattern,
                                   const char *sample, int line) {
  struct pat_ref_elt *elt;
 ...
 */
int pat_ref_add(struct pat_ref *ref, const char *pattern, const char *sample,
                char **err) {
...
/* This function looks up any existing reference <ref> in pattern_head <head>,
 * and returns the associated pattern_expr pointer if found, otherwise NULL.
 */
struct pattern_expr *pattern_lookup_expr(struct pattern_head *head,
                                         struct pat_ref *ref) {
  struct pattern_expr_list *expr;

  list_for_each_entry(expr, &head->head,
                      list) if (expr->expr->ref == ref) return expr->expr;
  return NULL;
}
 ...
 * flag <reuse> is set.
 */
struct pattern_expr *pattern_new_expr(struct pattern_head *head,
                                      struct pat_ref *ref, int patflags,
                                      char **err, int *reuse) {
  struct pattern_expr *expr;
   ...
   */
  if (ref) {
    list_for_each_entry(expr, &ref->pat,
                        list) if (expr->pat_head->index == head->index &&
                                  expr->pat_head->parse == head->parse &&
                                  expr->pat_head->parse_smp ==
                                      head->parse_smp &&
                                  expr->mflags == patflags) break;
 ...
 */
int pat_ref_read_from_file_smp(struct pat_ref *ref, const char *filename,
                               char **err) {
  FILE *file;
  char *c;
  int ret = 0;
  ...
  if (ferror(file)) {
    memprintf(err, "error encountered while reading  <%s> : %s", filename,
              strerror(errno));
    goto out_close;
  }
  /* success */
 ...
 * be returned there on errors and the caller will have to free it.
 */
int pat_ref_read_from_file(struct pat_ref *ref, const char *filename,
                           char **err) {
  FILE *file;
  char *c;
  char *arg;
  ...
  while (fgets(trash.area, trash.size, file) != NULL) {
    ...
    *c = 0;
    ...
    if (!pat_ref_append(ref, arg, NULL, line)) {
      memprintf(err, "out of memory when loading patterns from file <%s>",
                filename);
      goto out_close;
    }
  }
...
int pattern_read_from_file(struct pattern_head *head, unsigned int refflags,
  ...
  if (!ref) {
    chunk_printf(
        &trash, "pattern loaded from file '%s' used by %s at file '%s' line %d",
    ...
    if (load_smp) {
      if (!(ref->flags & PAT_REF_SMP)) {
        memprintf(err,
                  "The file \"%s\" is already used as one column file "
      ...
      if (ref->flags & PAT_REF_SMP) {
        memprintf(err,
                  "The file \"%s\" is already used as two column file "
  ...
  list_for_each_entry(elt, &ref->head, list) {
    if (!pat_ref_push(elt, expr, patflags, err)) {
      if (elt->line > 0)
        memprintf(err, "%s at line %d of file '%s'", *err, elt->line, filename);
      return 0;
    }
  }
 ...
 * returns non-null if the sample match. If <fill> is true and the sample match,
 * the function returns the matched pattern. In many cases, this pattern can be
 * a static buffer.
 */
struct pattern *pattern_exec_match(struct pattern_head *head,
                                   struct sample *smp, int fill) {
  struct pattern_expr_list *list;
  struct pattern *pat;
    ...
    if (pat) {
      ...
      if (pat->data && (pat->data != &static_sample_data)) {
        ...
        case SMP_T_STR:
          ...
          memcpy(static_sample_data.u.str.area, pat->data->u.str.area,
 ...
 */
struct sample_data **pattern_find_smp(struct pattern_expr *expr,
                                      struct pat_ref_elt *ref) {
  struct ebmb_node *node;
  struct pattern_tree *elt;
  struct pattern_list *pat;

  for (node = ebmb_first(&expr->pattern_tree); node; node = ebmb_next(node)) {
    elt = container_of(node, struct pattern_tree, node);
    if (elt->ref == ref)
      return &elt->data;
  }

  for (node = ebmb_first(&expr->pattern_tree_2); node; node = ebmb_next(node)) {
    elt = container_of(node, struct pattern_tree, node);
    if (elt->ref == ref)
      return &elt->data;
  }

  list_for_each_entry(pat, &expr->patterns,
                      list) if (pat->pat.ref == ref) return &pat->pat.data;
...
static void pattern_per_thread_lru_free() { lru64_destroy(pat_lru_tree); }
