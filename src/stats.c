...
const char *stat_status_codes[STAT_STATUS_SIZE] = {
    [STAT_STATUS_DENY] = "DENY", [STAT_STATUS_DONE] = "DONE",
    [STAT_STATUS_ERRP] = "ERRP", [STAT_STATUS_EXCD] = "EXCD",
    [STAT_STATUS_NONE] = "NONE", [STAT_STATUS_PART] = "PART",
    [STAT_STATUS_UNKN] = "UNKN", [STAT_STATUS_IVAL] = "IVAL",
};
...
const struct name_desc info_fields[INF_TOTAL_FIELDS] = {
    ...
    [INF_RELEASE_DATE] = {.name = "Release_date",
                          .desc = "Date of latest source code update"},
    [INF_NBTHREAD] = {.name = "Nbthread",
                      .desc = "Number of started threads (global.nbthread)"},
    [INF_NBPROC] = {.name = "Nbproc",
                    .desc =
                        "Number of started worker processes (global.nbproc)"},
    [INF_PROCESS_NUM] = {.name = "Process_num",
                         .desc = "Relative worker process number (1..Nbproc)"},
    [INF_PID] = {.name = "Pid",
                 .desc = "This worker process identifier for the system"},
    [INF_UPTIME] = {.name = "Uptime",
                    .desc = "How long ago this worker process was started "
                            "(days+hours+minutes+seconds)"},
    [INF_UPTIME_SEC] =
        {.name = "Uptime_sec",
         .desc = "How long ago this worker process was started (seconds)"},
    [INF_MEMMAX_MB] = {.name = "Memmax_MB",
                       .desc = "Worker process's hard limit on memory usage in "
                               "MB (-m on command line)"},
    [INF_POOL_ALLOC_MB] = {.name = "PoolAlloc_MB",
                           .desc =
                               "Amount of memory allocated in pools (in MB)"},
    [INF_POOL_USED_MB] = {.name = "PoolUsed_MB",
                          .desc =
                              "Amount of pool memory currently used (in MB)"},
    [INF_POOL_FAILED] =
        {.name = "PoolFailed",
         .desc =
    ...
    [INF_ULIMIT_N] =
        {.name = "Ulimit-n",
         .desc = "Hard limit on the number of per-process file descriptors"},
    [INF_MAXSOCK] = {.name = "Maxsock",
                     .desc = "Hard limit on the number of per-process sockets"},
    [INF_MAXCONN] = {.name = "Maxconn",
                     .desc = "Hard limit on the number of per-process "
                             "connections (configured or imposed by Ulimit-n)"},
    [INF_HARD_MAXCONN] = {.name = "Hard_maxconn",
                          .desc =
                              "Hard limit on the number of per-process "
                              "connections (imposed by Memmax_MB or Ulimit-n)"},
    [INF_CURR_CONN] =
        {.name = "CurrConns",
         .desc = "Current number of connections on this worker process"},
    [INF_CUM_CONN] = {.name = "CumConns",
                      .desc = "Total number of connections on this worker "
                              "process since started"},
    [INF_CUM_REQ] =
        {.name = "CumReq",
         .desc =
             "Total number of requests on this worker process since started"},
    [INF_MAX_SSL_CONNS] = {.name = "MaxSslConns",
                           .desc = "Hard limit on the number of per-process "
                                   "SSL endpoints (front+back), 0=unlimited"},
    [INF_CURR_SSL_CONNS] = {.name = "CurrSslConns",
                            .desc = "Current number of SSL endpoints on this "
                                    "worker process (front+back)"},
    [INF_CUM_SSL_CONNS] = {.name = "CumSslConns",
                           .desc = "Total number of SSL endpoints on this "
                                   "worker process since started (front+back)"},
    [INF_MAXPIPES] =
        {.name = "Maxpipes",
         .desc = "Hard limit on the number of pipes for splicing, 0=unlimited"},
    [INF_PIPES_USED] =
        {.name = "PipesUsed",
         .desc = "Current number of pipes in use in this worker process"},
    [INF_PIPES_FREE] = {.name = "PipesFree",
                        .desc = "Current number of allocated and available "
                                "pipes in this worker process"},
    [INF_CONN_RATE] = {.name = "ConnRate",
                       .desc = "Number of front connections created on this "
                               "worker process over the last second"},
    [INF_CONN_RATE_LIMIT] =
        {.name = "ConnRateLimit",
         .desc = "Hard limit for ConnRate (global.maxconnrate)"},
    [INF_MAX_CONN_RATE] =
        {.name = "MaxConnRate",
         .desc = "Highest ConnRate reached on this worker process since "
                 "started (in connections per second)"},
    [INF_SESS_RATE] = {.name = "SessRate",
                       .desc = "Number of sessions created on this worker "
                               "process over the last second"},
    [INF_SESS_RATE_LIMIT] =
        {.name = "SessRateLimit",
         .desc = "Hard limit for SessRate (global.maxsessrate)"},
    [INF_MAX_SESS_RATE] =
        {.name = "MaxSessRate",
         .desc = "Highest SessRate reached on this worker process since "
                 "started (in sessions per second)"},
    [INF_SSL_RATE] = {.name = "SslRate",
                      .desc = "Number of SSL connections created on this "
                              "worker process over the last second"},
    [INF_SSL_RATE_LIMIT] = {.name = "SslRateLimit",
                            .desc =
                                "Hard limit for SslRate (global.maxsslrate)"},
    [INF_MAX_SSL_RATE] = {.name = "MaxSslRate",
                          .desc =
                              "Highest SslRate reached on this worker process "
                              "since started (in connections per second)"},
    [INF_SSL_FRONTEND_KEY_RATE] =
        {.name = "SslFrontendKeyRate",
         .desc = "Number of SSL keys created on frontends in this worker "
                 "process over the last second"},
    [INF_SSL_FRONTEND_MAX_KEY_RATE] =
        {.name = "SslFrontendMaxKeyRate",
         .desc = "Highest SslFrontendKeyRate reached on this worker process "
                 "since started (in SSL keys per second)"},
    [INF_SSL_FRONTEND_SESSION_REUSE_PCT] =
        {.name = "SslFrontendSessionReuse_pct",
         .desc = "Percent of frontend SSL connections which did not require a "
                 "new key"},
    [INF_SSL_BACKEND_KEY_RATE] =
        {.name = "SslBackendKeyRate",
         .desc = "Number of SSL keys created on backends in this worker "
                 "process over the last second"},
    [INF_SSL_BACKEND_MAX_KEY_RATE] =
        {.name = "SslBackendMaxKeyRate",
         .desc = "Highest SslBackendKeyRate reached on this worker process "
                 "since started (in SSL keys per second)"},
    [INF_SSL_CACHE_LOOKUPS] =
        {.name = "SslCacheLookups",
         .desc = "Total number of SSL session ID lookups in the SSL session "
                 "cache on this worker since started"},
    [INF_SSL_CACHE_MISSES] =
        {.name = "SslCacheMisses",
         .desc =
             "Total number of SSL session ID lookups that didn't find a "
             "session in the SSL session cache on this worker since started"},
    [INF_COMPRESS_BPS_IN] =
        {.name = "CompressBpsIn",
         .desc = "Number of bytes submitted to the HTTP compressor in this "
                 "worker process over the last second"},
    [INF_COMPRESS_BPS_OUT] =
        {.name = "CompressBpsOut",
         .desc = "Number of bytes emitted by the HTTP compressor in this "
                 "worker process over the last second"},
    [INF_COMPRESS_BPS_RATE_LIM] =
        {.name = "CompressBpsRateLim",
         .desc = "Limit of CompressBpsOut beyond which HTTP compression is "
                 "automatically disabled"},
    [INF_ZLIB_MEM_USAGE] =
        {.name = "ZlibMemUsage",
         .desc = "Amount of memory currently used by HTTP compression on the "
                 "current worker process (in bytes)"},
    [INF_MAX_ZLIB_MEM_USAGE] =
        {.name = "MaxZlibMemUsage",
         .desc = "Limit on the amount of memory used by HTTP compression above "
                 "which it is automatically disabled (in bytes, see "
                 "global.maxzlibmem)"},
    [INF_TASKS] = {.name = "Tasks",
                   .desc = "Total number of tasks in the current worker "
                           "process (active + sleeping)"},
    [INF_RUN_QUEUE] = {.name = "Run_queue",
                       .desc = "Total number of active tasks+tasklets in the "
                               "current worker process"},
    [INF_IDLE_PCT] = {.name = "Idle_pct",
                      .desc = "Percentage of last second spent waiting in the "
                              "current worker thread"},
    [INF_NODE] = {.name = "node", .desc = "Node name (global.node)"},
    [INF_DESCRIPTION] = {.name = "description",
                         .desc = "Node description (global.description)"},
    [INF_STOPPING] =
        {.name = "Stopping",
         .desc =
    ...
    [INF_JOBS] =
        {.name = "Jobs",
         .desc = "Current number of active jobs on the current worker process "
                 "(frontend connections, master connections, listeners)"},
    [INF_UNSTOPPABLE_JOBS] =
        {.name = "Unstoppable Jobs",
         .desc = "Current number of unstoppable jobs on the current worker "
                 "process (master connections)"},
    [INF_LISTENERS] = {.name = "Listeners",
                       .desc = "Current number of active listeners on the "
                               "current worker process"},
    [INF_ACTIVE_PEERS] = {.name = "ActivePeers",
                          .desc = "Current number of verified active peers "
                                  "connections on the current worker process"},
    [INF_CONNECTED_PEERS] =
        {.name = "ConnectedPeers",
         .desc = "Current number of peers having passed the connection step on "
                 "the current worker process"},
    [INF_DROPPED_LOGS] = {.name = "DroppedLogs",
                          .desc = "Total number of dropped logs for current "
                                  "worker process since started"},
    [INF_BUSY_POLLING] =
        {.name = "BusyPolling",
         .desc = "1 if busy-polling is currently in use on the worker process, "
                 "otherwise zero (config.busy-polling)"},
    [INF_FAILED_RESOLUTIONS] = {.name = "FailedResolutions",
                                .desc =
                                    "Total number of failed DNS resolutions in "
                                    "current worker process since started"},
    [INF_TOTAL_BYTES_OUT] = {.name = "TotalBytesOut",
                             .desc = "Total number of bytes emitted by current "
                                     "worker process since started"},
    [INF_TOTAL_SPLICED_BYTES_OUT] =
        {.name = "TotalSplicdedBytesOut",
         .desc = "Total number of bytes emitted by current worker process "
                 "through a kernel pipe since started"},
    [INF_BYTES_OUT_RATE] = {.name = "BytesOutRate",
                            .desc = "Number of bytes emitted by current worker "
                                    "process over the last second"},
    [INF_DEBUG_COMMANDS_ISSUED] = {.name = "DebugCommandsIssued",
                                   .desc =
                                       "Number of debug commands issued on "
                                       "this process (anything > 0 is unsafe)"},
    [INF_CUM_LOG_MSGS] =
        {.name = "CumRecvLogs",
...
const struct name_desc stat_fields[ST_F_TOTAL_FIELDS] = {
    ...
    [ST_F_QCUR] = {.name = "qcur",
                   .desc = "Current number of connections waiting in the "
                           "server of backend queue"},
    [ST_F_QMAX] =
        {.name = "qmax",
    ...
    [ST_F_SCUR] =
        {.name = "scur",
         .desc =
             "Current number of sessions on the frontend, backend or server"},
    [ST_F_SMAX] =
        {.name = "smax",
    ...
    [ST_F_DRESP] =
        {.name = "dresp",
         .desc = "Total number of denied responses since process started"},
    [ST_F_EREQ] =
        {.name = "ereq",
         .desc = "Total number of invalid requests since process started"},
    [ST_F_ECON] = {.name = "econ",
                   .desc = "Total number of failed connections to server since "
                           "the worker process started"},
    [ST_F_ERESP] = {.name = "eresp",
                    .desc = "Total number of invalid responses since the "
                            "worker process started"},
    [ST_F_WRETR] = {.name = "wretr",
                    .desc = "Total number of server connection retries since "
                            "the worker process started"},
    [ST_F_WREDIS] =
        {.name = "wredis",
         .desc = "Total number of server redispatches due to connection "
                 "failures since the worker process started"},
    [ST_F_STATUS] = {.name = "status",
                     .desc = "Frontend/listen status: OPEN/WAITING/FULL/STOP; "
                             "backend: UP/DOWN; server: last check status"},
    [ST_F_WEIGHT] = {.name = "weight",
                     .desc = "Server's effective weight, or sum of active "
                             "servers' effective weights for a backend"},
    [ST_F_ACT] =
        {.name = "act",
         .desc = "Total number of active UP servers with a non-zero weight"},
    [ST_F_BCK] =
        {.name = "bck",
         .desc = "Total number of backup UP servers with a non-zero weight"},
    [ST_F_CHKFAIL] = {.name = "chkfail",
                      .desc =
                          "Total number of failed individual health checks per "
                          "server/backend, since the worker process started"},
    [ST_F_CHKDOWN] = {.name = "chkdown",
                      .desc = "Total number of failed checks causing UP to "
                              "DOWN server transitions, per server/backend, "
                              "since the worker process started"},
    [ST_F_LASTCHG] =
        {.name = "lastchg",
         .desc = "How long ago the last server state changed, in seconds"},
    [ST_F_DOWNTIME] =
        {.name = "downtime",
         .desc = "Total time spent in DOWN state, for server or backend"},
    [ST_F_QLIMIT] = {.name = "qlimit",
                     .desc = "Limit on the number of connections in queue, for "
                             "servers only (maxqueue argument)"},
    [ST_F_PID] = {.name = "pid",
                  .desc = "Relative worker process number (1..nbproc)"},
    [ST_F_IID] = {.name = "iid",
                  .desc =
                      "Frontend or Backend numeric identifier ('id' setting)"},
    [ST_F_SID] = {.name = "sid",
                  .desc = "Server numeric identifier ('id' setting)"},
    [ST_F_THROTTLE] = {.name = "throttle",
                       .desc =
                           "Throttling ratio applied to a server's maxconn and "
                           "weight during the slowstart period (0 to 100%)"},
    [ST_F_LBTOT] =
        {.name = "lbtot",
         .desc = "Total number of requests routed by load balancing since the "
                 "worker process started (ignores queue pop and stickiness)"},
    [ST_F_TRACKED] =
        {.name = "tracked",
         .desc = "Name of the other server this server tracks for its state"},
    [ST_F_TYPE] =
        {.name = "type",
         .desc = "Type of the object (Listener, Frontend, Backend, Server)"},
    [ST_F_RATE] = {.name = "rate",
                   .desc =
                       "Total number of sessions processed by this object over "
                       "the last second (sessions for listeners/frontends, "
                       "requests for backends/servers)"},
    [ST_F_RATE_LIM] =
        {.name = "rate_lim",
         .desc = "Limit on the number of sessions accepted in a second "
                 "(frontend only, 'rate-limit sessions' setting)"},
    [ST_F_RATE_MAX] = {.name = "rate_max",
                       .desc = "Highest value of 'rate' observed since the "
                               "worker process started"},
    [ST_F_CHECK_STATUS] =
        {.name = "check_status",
    ...
    [ST_F_CHECK_CODE] = {.name = "check_code",
                         .desc = "HTTP/SMTP/LDAP status code reported by the "
                                 "latest server health check"},
    [ST_F_CHECK_DURATION] = {.name = "check_duration",
                             .desc = "Total duration of the latest server "
                                     "health check, in milliseconds"},
    [ST_F_HRSP_1XX] =
        {.name = "hrsp_1xx",
         .desc = "Total number of HTTP responses with status 100-199 returned "
                 "by this object since the worker process started"},
    [ST_F_HRSP_2XX] =
        {.name = "hrsp_2xx",
         .desc = "Total number of HTTP responses with status 200-299 returned "
                 "by this object since the worker process started"},
    [ST_F_HRSP_3XX] =
        {.name = "hrsp_3xx",
         .desc = "Total number of HTTP responses with status 300-399 returned "
                 "by this object since the worker process started"},
    [ST_F_HRSP_4XX] =
        {.name = "hrsp_4xx",
         .desc = "Total number of HTTP responses with status 400-499 returned "
                 "by this object since the worker process started"},
    [ST_F_HRSP_5XX] =
        {.name = "hrsp_5xx",
         .desc = "Total number of HTTP responses with status 500-599 returned "
                 "by this object since the worker process started"},
    [ST_F_HRSP_OTHER] = {.name = "hrsp_other",
                         .desc = "Total number of HTTP responses with status "
                                 "<100, >599 returned by this object since the "
                                 "worker process started (error -1 included)"},
    [ST_F_HANAFAIL] =
        {.name = "hanafail",
    ...
    [ST_F_REQ_RATE] = {.name = "req_rate",
                       .desc = "Number of HTTP requests processed over the "
                               "last second on this object"},
    [ST_F_REQ_RATE_MAX] = {.name = "req_rate_max",
                           .desc = "Highest value of 'req_rate' observed since "
                                   "the worker process started"},
    [ST_F_REQ_TOT] = {.name = "req_tot",
                      .desc = "Total number of HTTP requests processed by this "
                              "object since the worker process started"},
    [ST_F_CLI_ABRT] = {.name = "cli_abrt",
                       .desc =
                           "Total number of requests or connections aborted by "
                           "the client since the worker process started"},
    [ST_F_SRV_ABRT] = {.name = "srv_abrt",
                       .desc =
                           "Total number of requests or connections aborted by "
                           "the server since the worker process started"},
    [ST_F_COMP_IN] =
        {.name = "comp_in",
         .desc = "Total number of bytes submitted to the HTTP compressor for "
                 "this object since the worker process started"},
    [ST_F_COMP_OUT] =
        {.name = "comp_out",
         .desc = "Total number of bytes emitted by the HTTP compressor for "
                 "this object since the worker process started"},
    [ST_F_COMP_BYP] = {.name = "comp_byp",
                       .desc =
                           "Total number of bytes that bypassed HTTP "
                           "compression for this object since the worker "
                           "process started (CPU/memory/bandwidth limitation)"},
    [ST_F_COMP_RSP] =
        {.name = "comp_rsp",
         .desc = "Total number of HTTP responses that were compressed for this "
                 "object since the worker process started"},
    [ST_F_LASTSESS] = {.name = "lastsess",
                       .desc = "How long ago some traffic was seen on this "
                               "object on this worker process, in seconds"},
    [ST_F_LAST_CHK] = {.name = "last_chk",
                       .desc = "Short description of the latest health check "
                               "report for this server (see also check_desc)"},
    [ST_F_LAST_AGT] = {.name = "last_agt",
                       .desc = "Short description of the latest agent check "
                               "report for this server (see also agent_desc)"},
    [ST_F_QTIME] = {.name = "qtime",
                    .desc =
                        "Time spent in the queue, in milliseconds, averaged "
                        "over the 1024 last requests (backend/server)"},
    [ST_F_CTIME] = {.name = "ctime",
                    .desc = "Time spent waiting for a connection to complete, "
                            "in milliseconds, averaged over the 1024 last "
                            "requests (backend/server)"},
    [ST_F_RTIME] =
        {.name = "rtime",
         .desc = "Time spent waiting for a server response, in milliseconds, "
                 "averaged over the 1024 last requests (backend/server)"},
    [ST_F_TTIME] =
        {.name = "ttime",
         .desc =
             "Total request+response time "
             "(request+queue+connect+response+processing), in milliseconds, "
             "averaged over the 1024 last requests (backend/server)"},
    [ST_F_AGENT_STATUS] =
        {.name = "agent_status",
         .desc = "Status report of the server's latest agent check, prefixed "
                 "with '*' if a check is currently in progress"},
    [ST_F_AGENT_CODE] =
        {.name = "agent_code",
         .desc = "Status code reported by the latest server agent check"},
    [ST_F_AGENT_DURATION] = {.name = "agent_duration",
                             .desc = "Total duration of the latest server "
                                     "agent check, in milliseconds"},
    [ST_F_CHECK_DESC] = {.name = "check_desc",
                         .desc = "Textual description of the latest health "
                                 "check report for this server"},
    [ST_F_AGENT_DESC] = {.name = "agent_desc",
                         .desc = "Textual description of the latest agent "
                                 "check report for this server"},
    [ST_F_CHECK_RISE] = {.name = "check_rise",
                         .desc =
                             "Number of successful health checks before "
                             "declaring a server UP (server 'rise' setting)"},
    [ST_F_CHECK_FALL] = {.name = "check_fall",
                         .desc =
                             "Number of failed health checks before declaring "
                             "a server DOWN (server 'fall' setting)"},
    [ST_F_CHECK_HEALTH] = {.name = "check_health",
                           .desc = "Current server health check level "
                                   "(0..fall-1=DOWN, fall..rise-1=UP)"},
    [ST_F_AGENT_RISE] = {.name = "agent_rise",
                         .desc =
                             "Number of successful agent checks before "
                             "declaring a server UP (server 'rise' setting)"},
    [ST_F_AGENT_FALL] = {.name = "agent_fall",
                         .desc =
                             "Number of failed agent checks before declaring a "
                             "server DOWN (server 'fall' setting)"},
    [ST_F_AGENT_HEALTH] = {.name = "agent_health",
                           .desc = "Current server agent check level "
                                   "(0..fall-1=DOWN, fall..rise-1=UP)"},
    [ST_F_ADDR] = {.name = "addr",
                   .desc = "Server's address:port, shown only if show-legends "
                           "is set, or at levels oper/admin for the CLI"},
    [ST_F_COOKIE] =
        {.name = "cookie",
         .desc = "Backend's cookie name or Server's cookie value, shown only "
                 "if show-legends is set, or at levels oper/admin for the CLI"},
    [ST_F_MODE] = {.name = "mode",
                   .desc = "'mode' setting (tcp/http/health/cli)"},
    [ST_F_ALGO] =
        {.name = "algo",
         .desc = "Backend's load balancing algorithm, shown only if "
                 "show-legends is set, or at levels oper/admin for the CLI"},
    [ST_F_CONN_RATE] = {.name = "conn_rate",
                        .desc =
                            "Number of new connections accepted over the last "
                            "second on the frontend for this worker process"},
    [ST_F_CONN_RATE_MAX] = {.name = "conn_rate_max",
                            .desc = "Highest value of 'conn_rate' observed "
                                    "since the worker process started"},
    [ST_F_CONN_TOT] = {.name = "conn_tot",
                       .desc =
                           "Total number of new connections accepted on this "
                           "frontend since the worker process started"},
    [ST_F_INTERCEPTED] =
        {.name = "intercepted",
         .desc = "Total number of HTTP requests intercepted on the frontend "
                 "(redirects/stats/services) since the worker process started"},
    [ST_F_DCON] = {.name = "dcon",
                   .desc = "Total number of incoming connections blocked on a "
                           "listener/frontend by a tcp-request connection rule "
                           "since the worker process started"},
    [ST_F_DSES] = {.name = "dses",
                   .desc = "Total number of incoming sessions blocked on a "
                           "listener/frontend by a tcp-request connection rule "
                           "since the worker process started"},
    [ST_F_WREW] = {.name = "wrew",
                   .desc = "Total number of failed HTTP header rewrites since "
                           "the worker process started"},
    [ST_F_CONNECT] =
        {.name = "connect",
         .desc = "Total number of outgoing connection attempts on this "
                 "backend/server since the worker process started"},
    [ST_F_REUSE] = {.name = "reuse",
                    .desc = "Total number of reused connection on this "
                            "backend/server since the worker process started"},
    [ST_F_CACHE_LOOKUPS] =
        {.name = "cache_lookups",
         .desc = "Total number of HTTP requests looked up in the cache on this "
                 "frontend/backend since the worker process started"},
    [ST_F_CACHE_HITS] =
        {.name = "cache_hits",
         .desc = "Total number of HTTP requests not found in the cache on this "
                 "frontend/backend since the worker process started"},
    [ST_F_SRV_ICUR] = {.name = "srv_icur",
                       .desc = "Current number of idle connections available "
                               "for reuse on this server"},
    [ST_F_SRV_ILIM] = {.name = "src_ilim",
                       .desc =
                           "Limit on the number of available idle connections "
                           "on this server (server 'pool_max_conn' directive)"},
    [ST_F_QT_MAX] = {.name = "qtime_max",
                     .desc = "Maximum observed time spent in the queue, in "
                             "milliseconds (backend/server)"},
    [ST_F_CT_MAX] = {.name = "ctime_max",
                     .desc =
                         "Maximum observed time spent waiting for a connection "
                         "to complete, in milliseconds (backend/server)"},
    [ST_F_RT_MAX] = {.name = "rtime_max",
                     .desc = "Maximum observed time spent waiting for a server "
                             "response, in milliseconds (backend/server)"},
    [ST_F_TT_MAX] = {.name = "ttime_max",
                     .desc = "Maximum observed total request+response time "
                             "(request+queue+connect+response+processing), in "
                             "milliseconds (backend/server)"},
    [ST_F_EINT] = {.name = "eint",
                   .desc =
                       "Total number of internal errors since process started"},
    [ST_F_IDLE_CONN_CUR] = {.name = "idle_conn_cur",
                            .desc =
                                "Current number of unsafe idle connections"},
    [ST_F_SAFE_CONN_CUR] = {.name = "safe_conn_cur",
                            .desc = "Current number of safe idle connections"},
    ...
    [ST_F_UWEIGHT] = {.name = "uweight",
                      .desc = "Server's user weight, or sum of active servers' "
                              "user weights for a backend"},
};
 ...
 *     -> stats_dump_stat_to_buffer()     // same as above, but used for CSV or
 * HTML
 ...
 *        -> stats_dump_html_info()       // emits the equivalent of "show info"
 * at the top
...
/* Dumps the stats CSV header to the trash buffer which. The caller is
 * responsible for clearing it if needed. NOTE: Some tools happen to rely on the
 * field position instead of its name, so please only append new fields at the
...
int stats_emit_raw_data_field(struct buffer *out, const struct field *f) {
  ...
  case FF_EMPTY:
    return 1;
  case FF_S32:
    return chunk_appendf(out, "%d", f->u.s32);
  case FF_U32:
    return chunk_appendf(out, "%u", f->u.u32);
  case FF_S64:
    return chunk_appendf(out, "%lld", (long long)f->u.s64);
  case FF_U64:
    return chunk_appendf(out, "%llu", (unsigned long long)f->u.u64);
  case FF_FLT:
    return chunk_appendf(out, "%f", f->u.flt);
  case FF_STR:
    return csv_enc_append(field_str(f, 0), 1, out) != NULL;
  default:
    return chunk_appendf(out, "[INCORRECT_FIELD_TYPE_%08x]", f->type);
  }
}
...
int stats_emit_typed_data_field(struct buffer *out, const struct field *f) {
  ...
  case FF_EMPTY:
    return 1;
  case FF_S32:
    return chunk_appendf(out, "s32:%d", f->u.s32);
  case FF_U32:
    return chunk_appendf(out, "u32:%u", f->u.u32);
  case FF_S64:
    return chunk_appendf(out, "s64:%lld", (long long)f->u.s64);
  case FF_U64:
    return chunk_appendf(out, "u64:%llu", (unsigned long long)f->u.u64);
  case FF_FLT:
    return chunk_appendf(out, "flt:%f", f->u.flt);
  case FF_STR:
    return chunk_appendf(out, "str:%s", field_str(f, 0));
  default:
    return chunk_appendf(out, "%08x:?", f->type);
  }
}
...
int stats_emit_json_data_field(struct buffer *out, const struct field *f) {
  ...
  case FF_S64:
    ...
    break;
  case FF_U64:
    if (f->u.u64 > JSON_INT_MAX)
      return 0;
    type = "\"u64\"";
    snprintf(buf, sizeof(buf), "%llu", (unsigned long long)f->u.u64);
    break;
  case FF_FLT:
    type = "\"flt\"";
  ...
  case FF_STR:
    ...
    break;
  default:
    snprintf(buf, sizeof(buf), "%u", f->type);
    type = buf;
    value = "unknown";
    quote = "\"";
    break;
  ...
  old_len = out->data;
  chunk_appendf(out, ",\"value\":{\"type\":%s,\"value\":%s%s%s}", type, quote,
                value, quote);
...
static int stats_dump_fields_csv(struct buffer *out, const struct field *stats,
                                 size_t stats_count, unsigned int flags,
...
/* Dump all fields from <stats> into <out> using a typed "field:desc:type:value"
 * format */
static int stats_dump_fields_typed(struct buffer *out,
  ...
  for (field = 0; field < stats_count; ++field) {
    ...
    case STATS_DOMAIN_PROXY:
      chunk_appendf(
          out, "%c.%u.%u.%d.%s.%u:",
          stats[ST_F_TYPE].u.u32 == STATS_TYPE_FE
              ? 'F'
              : stats[ST_F_TYPE].u.u32 == STATS_TYPE_BE
                    ? 'B'
                    : stats[ST_F_TYPE].u.u32 == STATS_TYPE_SO
                          ? 'L'
                          : stats[ST_F_TYPE].u.u32 == STATS_TYPE_SV ? 'S' : '?',
          stats[ST_F_IID].u.u32, stats[ST_F_SID].u.u32, field,
          stat_f[domain][field].name, stats[ST_F_PID].u.u32);
      break;

    case STATS_DOMAIN_DNS:
      chunk_appendf(out, "D.%d.%s:", field, stat_f[domain][field].name);
      break;
...
static int stats_dump_json_info_fields(struct buffer *out,
  ...
  for (field = 0; field < INF_TOTAL_FIELDS; field++) {
    ...
    chunk_appendf(out,
                  "{\"field\":{\"pos\":%d,\"name\":\"%s\"},"
                  "\"processNum\":%u,",
                  field, info_fields[field].name, info[INF_PROCESS_NUM].u.u32);
    if (old_len == out->data)
      goto err;
...
static void stats_print_proxy_field_json(struct buffer *out,
                                         ...
                                         uint32_t field_type, uint32_t iid,
...
/* Dump all fields from <stats> into <out> using a typed "field:desc:type:value"
 * format */
static int stats_dump_fields_json(struct buffer *out, const struct field *stats,
                                  size_t stats_count, unsigned int flags,
                                  enum stats_domain domain) {
  int field;
  int started = 0;
  ...
  for (field = 0; field < stats_count; field++) {
    ...
    if (domain == STATS_DOMAIN_PROXY) {
      stats_print_proxy_field_json(
          ...
          stats[ST_F_TYPE].u.u32, stats[ST_F_IID].u.u32, stats[ST_F_SID].u.u32,
          stats[ST_F_PID].u.u32);
    } else if (domain == STATS_DOMAIN_DNS) {
      stats_print_dns_field_json(out, &stats[field], stat_f[domain][field].name,
                                 field);
    }
 ...
 * present in <flags>.
 */
static int stats_dump_fields_html(struct buffer *out, const struct field *stats,
                                  unsigned int flags) {
  struct buffer src;
  ...
  if (stats[ST_F_TYPE].u.u32 == STATS_TYPE_FE) {
    ...
    chunk_appendf(out,
                  ...
                  "",
                  U2H(stats[ST_F_RATE].u.u32), U2H(stats[ST_F_CONN_RATE].u.u32),
                  U2H(stats[ST_F_RATE].u.u32));

    if (strcmp(field_str(stats, ST_F_MODE), "http") == 0)
      chunk_appendf(out, "<tr><th>Current request rate:</th><td>%s/s</td></tr>",
    ...
    if (strcmp(field_str(stats, ST_F_MODE), "http") == 0)
      chunk_appendf(out, "<tr><th>Max request rate:</th><td>%s/s</td></tr>",
    ...
    chunk_appendf(out,
                  ...
                  "",
                  U2H(stats[ST_F_SCUR].u.u32), U2H(stats[ST_F_SMAX].u.u32),
                  U2H(stats[ST_F_SLIM].u.u32), U2H(stats[ST_F_STOT].u.u64),
                  U2H(stats[ST_F_CONN_TOT].u.u64), U2H(stats[ST_F_STOT].u.u64));
    ...
    if (strcmp(field_str(stats, ST_F_MODE), "http") == 0) {
      chunk_appendf(
          ...
          "",
          U2H(stats[ST_F_REQ_TOT].u.u64), U2H(stats[ST_F_HRSP_1XX].u.u64),
          U2H(stats[ST_F_HRSP_2XX].u.u64), U2H(stats[ST_F_COMP_RSP].u.u64),
          stats[ST_F_HRSP_2XX].u.u64 ? (int)(100 * stats[ST_F_COMP_RSP].u.u64 /
                                             stats[ST_F_HRSP_2XX].u.u64)
                                     : 0,
          U2H(stats[ST_F_HRSP_3XX].u.u64), U2H(stats[ST_F_HRSP_4XX].u.u64),
          U2H(stats[ST_F_HRSP_5XX].u.u64), U2H(stats[ST_F_HRSP_OTHER].u.u64),
          ...
          stats[ST_F_CACHE_LOOKUPS].u.u64
              ? (int)(100 * stats[ST_F_CACHE_HITS].u.u64 /
                      stats[ST_F_CACHE_LOOKUPS].u.u64)
              : 0,
          U2H(stats[ST_F_WREW].u.u64), U2H(stats[ST_F_EINT].u.u64));
    }
    ...
    chunk_appendf(
        out,
        /* bytes:out + compression stats (via hover): comp_in, comp_out,
           comp_byp */
        ...
        U2H(stats[ST_F_BOUT].u.u64), U2H(stats[ST_F_BOUT].u.u64),
        U2H(stats[ST_F_COMP_IN].u.u64), U2H(stats[ST_F_COMP_OUT].u.u64),
        stats[ST_F_COMP_IN].u.u64 ? (int)(stats[ST_F_COMP_OUT].u.u64 * 100 /
                                          stats[ST_F_COMP_IN].u.u64)
                                  : 0,
        U2H(stats[ST_F_COMP_BYP].u.u64),
        U2H(stats[ST_F_COMP_IN].u.u64 - stats[ST_F_COMP_OUT].u.u64),
        stats[ST_F_BOUT].u.u64
            ? (int)((stats[ST_F_COMP_IN].u.u64 - stats[ST_F_COMP_OUT].u.u64) *
                    100 / stats[ST_F_BOUT].u.u64)
            : 0,
        (stats[ST_F_COMP_IN].u.u64 || stats[ST_F_COMP_BYP].u.u64) ? "</u>"
                                                                  : "");
    ...
    chunk_appendf(out,
                  ...
                  U2H(stats[ST_F_EREQ].u.u64), field_str(stats, ST_F_STATUS));
    ...
    if (flags & STAT_SHMODULES) {
      list_for_each_entry(mod, &stats_module_list[STATS_DOMAIN_PROXY], list) {
        ...
        if (stats_px_get_cap(mod->domain_flags) & STATS_PX_CAP_FE) {
          chunk_appendf(out, "<u>%s<div class=tips><table class=det>",
                        mod->name);
          for (j = 0; j < mod->stats_count; ++j) {
            chunk_appendf(out, "<tr><th>%s</th><td>%s</td></tr>",
                          mod->stats[j].desc,
                          field_to_html_str(&stats[ST_F_TOTAL_FIELDS + i]));
            ++i;
          }
    ...
    if (strcmp(field_str(stats, ST_F_STATUS), "DOWN") == 0 ||
      ...
      style = "no_check";
               ...
               stats[ST_F_CHECK_HEALTH].u.u32 ==
                   stats[ST_F_CHECK_RISE].u.u32 + stats[ST_F_CHECK_FALL].u.u32 -
                       1) {
    ...
    if (strncmp(field_str(stats, ST_F_STATUS), "MAINT", 5) == 0)
      ...
      chunk_appendf(out, "<tr class=\"%s_%s\">",
                    (stats[ST_F_BCK].u.u32) ? "backup" : "active", style);

    if (flags & STAT_ADMIN)
      chunk_appendf(out,
                    "<td><input class='%s-checkbox' type=\"checkbox\" "
                    "name=\"s\" value=\"%s\"></td>",
    ...
    chunk_appendf(
        ...
        "<tr><th>Cum. sessions:</th><td>%s</td></tr>"
        "",
        U2H(stats[ST_F_SCUR].u.u32), U2H(stats[ST_F_SCUR].u.u32),
        U2H(stats[ST_F_USED_CONN_CUR].u.u32), U2H(stats[ST_F_SRV_ICUR].u.u32),
        ...
        U2H(stats[ST_F_STOT].u.u64), U2H(stats[ST_F_STOT].u.u64));
    ...
    if (strcmp(field_str(stats, ST_F_MODE), "http") == 0) {
      chunk_appendf(
          ...
          "",
          U2H(stats[ST_F_CONNECT].u.u64), U2H(stats[ST_F_REUSE].u.u64),
          (stats[ST_F_CONNECT].u.u64 + stats[ST_F_REUSE].u.u64)
              ? (int)(100 * stats[ST_F_REUSE].u.u64 /
                      (stats[ST_F_CONNECT].u.u64 + stats[ST_F_REUSE].u.u64))
              : 0,
          U2H(stats[ST_F_REQ_TOT].u.u64), U2H(stats[ST_F_HRSP_1XX].u.u64),
          stats[ST_F_REQ_TOT].u.u64 ? (int)(100 * stats[ST_F_HRSP_1XX].u.u64 /
                                            stats[ST_F_REQ_TOT].u.u64)
                                    : 0,
          U2H(stats[ST_F_HRSP_2XX].u.u64),
          stats[ST_F_REQ_TOT].u.u64 ? (int)(100 * stats[ST_F_HRSP_2XX].u.u64 /
                                            stats[ST_F_REQ_TOT].u.u64)
                                    : 0,
          U2H(stats[ST_F_HRSP_3XX].u.u64),
          stats[ST_F_REQ_TOT].u.u64 ? (int)(100 * stats[ST_F_HRSP_3XX].u.u64 /
                                            stats[ST_F_REQ_TOT].u.u64)
                                    : 0,
          U2H(stats[ST_F_HRSP_4XX].u.u64),
          stats[ST_F_REQ_TOT].u.u64 ? (int)(100 * stats[ST_F_HRSP_4XX].u.u64 /
                                            stats[ST_F_REQ_TOT].u.u64)
                                    : 0,
          U2H(stats[ST_F_HRSP_5XX].u.u64),
          stats[ST_F_REQ_TOT].u.u64 ? (int)(100 * stats[ST_F_HRSP_5XX].u.u64 /
                                            stats[ST_F_REQ_TOT].u.u64)
                                    : 0,
          U2H(stats[ST_F_HRSP_OTHER].u.u64),
          stats[ST_F_REQ_TOT].u.u64 ? (int)(100 * stats[ST_F_HRSP_OTHER].u.u64 /
                                            stats[ST_F_REQ_TOT].u.u64)
                                    : 0,
          U2H(stats[ST_F_WREW].u.u64), U2H(stats[ST_F_EINT].u.u64));
    }
    ...
    chunk_appendf(
        out,
        "<tr><th colspan=3>Max / Avg over last 1024 success. conn.</th></tr>");
    chunk_appendf(out,
                  "<tr><th>- Queue time:</th><td>%s / %s</td><td>ms</td></tr>",
                  U2H(stats[ST_F_QT_MAX].u.u32), U2H(stats[ST_F_QTIME].u.u32));
    chunk_appendf(
        out, "<tr><th>- Connect time:</th><td>%s / %s</td><td>ms</td></tr>",
        U2H(stats[ST_F_CT_MAX].u.u32), U2H(stats[ST_F_CTIME].u.u32));
    if (strcmp(field_str(stats, ST_F_MODE), "http") == 0)
      chunk_appendf(
          out, "<tr><th>- Responses time:</th><td>%s / %s</td><td>ms</td></tr>",
          U2H(stats[ST_F_RT_MAX].u.u32), U2H(stats[ST_F_RTIME].u.u32));
    chunk_appendf(out,
                  "<tr><th>- Total time:</th><td>%s / %s</td><td>ms</td></tr>",
    ...
    chunk_appendf(out,
                  ...
                  "<td></td><td>%s</td>"
                  /* errors : response */
                  "<td><u>%s<div class=tips>Connection resets during "
                  "transfers: %lld client, %lld server</div></u></td>"
                  /* warnings: retries, redispatches */
                  "<td>%lld</td><td>%lld</td>"
                  "",
                  U2H(stats[ST_F_BIN].u.u64), U2H(stats[ST_F_BOUT].u.u64),
                  U2H(stats[ST_F_DRESP].u.u64), U2H(stats[ST_F_ECON].u.u64),
    ...
    /* FIXME!!!!
     *   LASTCHG should contain the last change for *this* server and must be
     * computed properly above, as was done below, ie: this server if maint,
     * otherwise ref server if tracking. Note that ref is either local or remote
    ...
    if (strncmp(field_str(stats, ST_F_STATUS), "MAINT", 5) == 0) {
      ...
      chunk_appendf(out, "%s %s", human_time(stats[ST_F_LASTCHG].u.u32, 1),
      ...
      } else if (stats[ST_F_CHECK_HEALTH].u.u32 <
                 stats[ST_F_CHECK_RISE].u.u32 + stats[ST_F_CHECK_FALL].u.u32 -
                     1)
    ...
    if (strncmp(field_str(stats, ST_F_STATUS), "DOWN", 4) == 0 &&
      ...
      chunk_appendf(out, "</td><td class=ac><u> %s",
      ...
      chunk_appendf(out, "<div class=tips>%s",
                    field_str(stats, ST_F_AGENT_DESC));
      ...
      chunk_appendf(out, "<div class=tips>%s",
                    field_str(stats, ST_F_CHECK_DESC));
    ...
    if (strcmp(field_str(stats, ST_F_STATUS), "MAINT (resolution)") == 0) {
      ...
      chunk_appendf(out,
                    ...
                    (long long)stats[ST_F_CHKDOWN].u.u64,
                    human_time(stats[ST_F_DOWNTIME].u.u32, 1));
    } else if (strcmp(field_str(stats, ST_F_STATUS), "MAINT") != 0 &&
               field_format(stats, ST_F_TRACKED) == FF_STR) {
      /* tracking a server (hence inherited maint would appear as "MAINT
       * (via...)" */
      chunk_appendf(
          out,
    ...
    chunk_appendf(
        ...
        "<td></td><td>%s</td>"
        /* errors : response */
        "<td><u>%s<div class=tips>Connection resets during transfers: %lld "
        "client, %lld server</div></u></td>"
        /* warnings: retries, redispatches */
        "<td>%lld</td><td>%lld</td>"
    ...
    chunk_appendf(out,
                  /* rest of backend: nothing, down transitions, total downtime,
                     throttle */
                  "<td class=ac>&nbsp;</td><td>%d</td>"
                  "<td>%s</td>"
                  "<td></td>",
                  stats[ST_F_CHKDOWN].u.u32,
                  stats[ST_F_DOWNTIME].type
                      ? human_time(stats[ST_F_DOWNTIME].u.u32, 1)
                      : "&nbsp;");
...
int stats_dump_one_line(const struct field *stats, size_t stats_count,
  ...
  if (appctx->ctx.stats.flags & STAT_FMT_HTML)
    ...
    ret = stats_dump_fields_typed(&trash, stats, stats_count,
                                  appctx->ctx.stats.flags,
                                  appctx->ctx.stats.domain);
  else if (appctx->ctx.stats.flags & STAT_FMT_JSON)
    ret = stats_dump_fields_json(&trash, stats, stats_count,
                                 appctx->ctx.stats.flags,
                                 appctx->ctx.stats.domain);
  else
    ret = stats_dump_fields_csv(&trash, stats, stats_count,
                                appctx->ctx.stats.flags,
                                appctx->ctx.stats.domain);
...
int stats_fill_fe_stats(struct proxy *px, struct field *stats, int len) {
  ...
  if (px->mode == PR_MODE_HTTP) {
    ...
    stats[ST_F_INTERCEPTED] =
        mkf_u64(FN_COUNTER, px->fe_counters.intercepted_req);
    stats[ST_F_CACHE_LOOKUPS] =
        mkf_u64(FN_COUNTER, px->fe_counters.p.http.cache_lookups);
    stats[ST_F_CACHE_HITS] =
        mkf_u64(FN_COUNTER, px->fe_counters.p.http.cache_hits);
  }
...
static int stats_dump_fe_stats(struct stream_interface *si, struct proxy *px) {
  ...
  if ((appctx->ctx.stats.flags & STAT_BOUND) &&
      !(appctx->ctx.stats.type & (1 << STATS_TYPE_FE)))
    return 0;
...
int stats_fill_li_stats(struct proxy *px, struct listener *l, int flags,
  ...
  stats[ST_F_STATUS] =
      mkf_str(FO_STATUS, (!l->maxconn || l->nbconn < l->maxconn)
                             ? (l->state == LI_LIMITED) ? "WAITING" : "OPEN"
                             : "FULL");
  stats[ST_F_PID] = mkf_u32(FO_KEY, relative_pid);
  stats[ST_F_IID] = mkf_u32(FO_KEY | FS_SERVICE, px->uuid);
 ...
 */
static int stats_dump_li_stats(struct stream_interface *si, struct proxy *px,
                               struct listener *l) {
  struct appctx *appctx = __objt_appctx(si->end);
  struct field *stats = stat_l[STATS_DOMAIN_PROXY];
  struct stats_module *mod;
...
int stats_fill_sv_stats(struct proxy *px, struct server *sv, int flags,
   ...
   * configuration, and "ref" which is the checked server and the end of the
   * chain.
   */
  ...
  if (sv->cur_state == SRV_ST_RUNNING || sv->cur_state == SRV_ST_STARTING) {
    ...
    if ((ref->agent.state & CHK_ST_ENABLED) && !ref->agent.health) {
      ...
      state = SRV_STATS_STATE_DOWN; /* DOWN */
               ...
               (ref->check.state & CHK_ST_ENABLED)) {
  ...
  if (sv->cur_admin & SRV_ADMF_RMAINT)
    ...
    chunk_appendf(out, srv_hlt_st[state],
                  (ref->cur_state != SRV_ST_STOPPED)
                      ? (ref->check.health - ref->check.rise + 1)
                      : (ref->check.health),
                  (ref->cur_state != SRV_ST_STOPPED) ? (ref->check.fall)
                                                     : (ref->check.rise));

  stats[ST_F_STATUS] = mkf_str(FO_STATUS, fld_status);
  stats[ST_F_LASTCHG] = mkf_u32(FN_AGE, now.tv_sec - sv->last_change);
  stats[ST_F_WEIGHT] =
      mkf_u32(FN_AVG, (sv->cur_eweight * px->lbprm.wmult + px->lbprm.wdiv - 1) /
                          px->lbprm.wdiv);
  ...
  if ((sv->check.state & (CHK_ST_ENABLED | CHK_ST_PAUSED)) == CHK_ST_ENABLED) {
    ...
    stats[ST_F_CHECK_DESC] =
        mkf_str(FN_OUTPUT, get_check_status_description(sv->check.status));
    ...
    stats[ST_F_CHECK_HEALTH] =
        mkf_u32(FO_CONFIG | FS_SERVICE, ref->check.health);
  }
  ...
  if ((sv->agent.state & (CHK_ST_ENABLED | CHK_ST_PAUSED)) == CHK_ST_ENABLED) {
    ...
    stats[ST_F_AGENT_DESC] =
        mkf_str(FN_OUTPUT, get_check_status_description(sv->agent.status));
    ...
    stats[ST_F_AGENT_HEALTH] =
        mkf_u32(FO_CONFIG | FS_SERVICE, sv->agent.health);
  }
  ...
  srv_samples_counter = (px->mode == PR_MODE_HTTP) ? sv->counters.p.http.cum_req
                                                   : sv->counters.cum_lbconn;
  if (srv_samples_counter < TIME_STATS_SAMPLES && srv_samples_counter > 0)
    srv_samples_window = srv_samples_counter;

  stats[ST_F_QTIME] =
      mkf_u32(FN_AVG, swrate_avg(sv->counters.q_time, srv_samples_window));
  stats[ST_F_CTIME] =
      mkf_u32(FN_AVG, swrate_avg(sv->counters.c_time, srv_samples_window));
  stats[ST_F_RTIME] =
      mkf_u32(FN_AVG, swrate_avg(sv->counters.d_time, srv_samples_window));
  stats[ST_F_TTIME] =
      mkf_u32(FN_AVG, swrate_avg(sv->counters.t_time, srv_samples_window));
  ...
  if (flags & STAT_SHLGNDS) {
    ...
    if (sv->cookie)
      stats[ST_F_COOKIE] =
          mkf_str(FO_CONFIG | FN_NAME | FS_SERVICE, sv->cookie);
  }
 ...
 * returns 1. <flags> can take the value STAT_SHLGNDS.
 */
int stats_fill_be_stats(struct proxy *px, int flags, struct field *stats,
                        int len) {
  ...
  stats[ST_F_WEIGHT] = mkf_u32(
      FN_AVG, (px->lbprm.tot_weight * px->lbprm.wmult + px->lbprm.wdiv - 1) /
                  px->lbprm.wdiv);
  ...
  if (flags & STAT_SHLGNDS) {
    if (px->cookie_name)
      stats[ST_F_COOKIE] =
          mkf_str(FO_CONFIG | FN_NAME | FS_SERVICE, px->cookie_name);
    stats[ST_F_ALGO] =
        mkf_str(FO_CONFIG | FS_SERVICE,
  ...
  if (px->mode == PR_MODE_HTTP) {
    ...
    stats[ST_F_CACHE_LOOKUPS] =
        mkf_u64(FN_COUNTER, px->be_counters.p.http.cache_lookups);
    stats[ST_F_CACHE_HITS] =
        mkf_u64(FN_COUNTER, px->be_counters.p.http.cache_hits);
  }
  ...
  be_samples_counter = (px->mode == PR_MODE_HTTP)
  ...
  stats[ST_F_QTIME] =
      mkf_u32(FN_AVG, swrate_avg(px->be_counters.q_time, be_samples_window));
  stats[ST_F_CTIME] =
      mkf_u32(FN_AVG, swrate_avg(px->be_counters.c_time, be_samples_window));
  stats[ST_F_RTIME] =
      mkf_u32(FN_AVG, swrate_avg(px->be_counters.d_time, be_samples_window));
  stats[ST_F_TTIME] =
      mkf_u32(FN_AVG, swrate_avg(px->be_counters.t_time, be_samples_window));
...
static int stats_dump_be_stats(struct stream_interface *si, struct proxy *px) {
  ...
  if ((appctx->ctx.stats.flags & STAT_BOUND) &&
      !(appctx->ctx.stats.type & (1 << STATS_TYPE_BE)))
    return 0;

  memset(stats, 0, sizeof(struct field) * stat_count[STATS_DOMAIN_PROXY]);

  if (!stats_fill_be_stats(px, appctx->ctx.stats.flags, stats,
                           ST_F_TOTAL_FIELDS))
    return 0;
...
/* Dumps the HTML table header for proxy <px> to the trash for and uses the
 * state from stream interface <si> and per-uri parameters <uri>. The caller is
 * responsible for clearing the trash if needed.
 */
static void stats_dump_html_px_hdr(struct stream_interface *si,
                                   struct proxy *px) {
  struct appctx *appctx = __objt_appctx(si->end);
  ...
  if (px->cap & PR_CAP_BE && px->srv &&
    ...
    /* scope_txt = search pattern + search query, appctx->ctx.stats.scope_len is
     * always <= STAT_SCOPE_TXT_MAXLEN */
    scope_txt[0] = 0;
    if (appctx->ctx.stats.scope_len) {
      const char *scope_ptr = stats_scope_ptr(appctx, si);

      strcpy(scope_txt, STAT_SCOPE_PATTERN);
      memcpy(scope_txt + strlen(STAT_SCOPE_PATTERN), scope_ptr,
             appctx->ctx.stats.scope_len);
      scope_txt[strlen(STAT_SCOPE_PATTERN) + appctx->ctx.stats.scope_len] = 0;
    }

    chunk_appendf(&trash, "<form method=\"post\">");
  }

  /* print a new table */
  chunk_appendf(&trash, "<table class=\"tbl\" width=\"100%%\">\n"
                        "<tr class=\"titre\">"
  ...
  chunk_appendf(&trash,
                ...
                px->id, (appctx->ctx.stats.flags & STAT_SHLGNDS) ? "<u>" : "",
                px->id, px->id);
  ...
  chunk_appendf(&trash,
                ...
                "<th>Limit</th><th>Total</th><th>LbTot</th><th>Last</"
                "th><th>In</th><th>Out</th>"
...
/* Dumps the HTML table trailer for proxy <px> to the trash for and uses the
 * state from stream interface <si>. The caller is responsible for clearing the
 * trash if needed.
 */
static void stats_dump_html_px_end(struct stream_interface *si,
                                   struct proxy *px) {
  struct appctx *appctx = __objt_appctx(si->end);
...
int stats_dump_proxy_to_buffer(struct stream_interface *si, struct htx *htx,
  ...
  struct server *sv,
      *svs; /* server and server-state, server-state=server or server->track */
  struct listener *l;
  ...
  case STAT_PX_ST_INIT:
    ...
    if (appctx->ctx.stats.scope_len) {
      ...
      if (strnistr(px->id, strlen(px->id), scope_ptr,
                   appctx->ctx.stats.scope_len) == NULL)
        return 1;
    }

    if ((appctx->ctx.stats.flags & STAT_BOUND) &&
        (appctx->ctx.stats.iid != -1) && (px->uuid != appctx->ctx.stats.iid))
      return 1;
  ...
  case STAT_PX_ST_LI:
    ...
    for (; appctx->ctx.stats.obj2 != &px->conf.listeners;
         appctx->ctx.stats.obj2 = l->by_fe.n) {
      if (htx) {
...
static void stats_dump_html_head(struct appctx *appctx, struct uri_auth *uri) {
  ...
  chunk_appendf(
      ...
      "table.tbl td { text-align: right; border-width: 1px 1px 1px 1px; "
      "border-style: solid solid solid solid; padding: 2px 3px; border-color: "
      "gray; white-space: nowrap;}\n"
      "table.tbl td.ac { text-align: center;}\n"
      "table.tbl th { border-width: 1px; border-style: solid solid solid "
      "solid; border-color: gray;}\n"
      "table.tbl th.pxname { background: #b00040; color: #ffff40; font-weight: "
      "bold; border-style: solid solid none solid; padding: 2px 3px; "
      "white-space: nowrap;}\n"
      "table.tbl th.empty { border-style: none; empty-cells: hide; background: "
      "white;}\n"
      "table.tbl th.desc { background: white; border-style: solid solid none "
      "solid; text-align: left; padding: 2px 3px;}\n"
      "\n"
      "table.lgd { border-collapse: collapse; border-width: 1px; border-style: "
      "none none none solid; border-color: black;}\n"
      "table.lgd td { border-width: 1px; border-style: solid solid solid "
      "solid; border-color: gray; padding: 2px;}\n"
      "table.lgd td.noborder { border-style: none; padding: 2px; white-space: "
      "nowrap;}\n"
      "table.det { border-collapse: collapse; border-style: none; }\n"
      "table.det th { text-align: left; border-width: 0px; padding: 0px 1px "
      "0px 0px; font-style:normal;font-size:11px;font-weight:bold;font-family: "
      "sans-serif;}\n"
      "table.det td { text-align: right; border-width: 0px; padding: 0px 0px "
      "0px 4px; white-space: nowrap; "
      ...
      " -moz-box-shadow:gray 2px 2px 3px;-webkit-box-shadow:gray 2px 2px "
      "3px;box-shadow:gray 2px 2px 3px;\n"
      "}\n"
      "u:hover div.tips {visibility:visible;}\n"
      "-->\n"
      "</style></head>\n",
      (appctx->ctx.stats.flags & STAT_SHNODE) ? " on " : "",
      (appctx->ctx.stats.flags & STAT_SHNODE)
          ? (uri && uri->node ? uri->node : global.node)
          : "");
}

/* Dumps the HTML stats information block to the trash for and uses the state
 * from stream interface <si> and per-uri parameters <uri>. The caller is
 * responsible for clearing the trash if needed.
 */
static void stats_dump_html_info(struct stream_interface *si,
  ...
  unsigned long long bps =
      (unsigned long long)read_freq_ctr(&global.out_32bps) * 32;
  ...
  chunk_appendf(
      &trash,
      "<body><h1><a href=\"" PRODUCT_URL
      "\" style=\"text-decoration: none;\">" PRODUCT_NAME "%s</a></h1>\n"
      ...
      "current conns = %d; current pipes = %d/%d; conn rate = %d/sec; bit rate "
      "= %.3f %cbps<br>\n"
      "Running tasks: %d/%d; idle = %d %%<br>\n"
      "</td><td align=\"center\" nowrap>\n"
      "<table class=\"lgd\"><tr>\n"
      "<td class=\"active_up\">&nbsp;</td><td class=\"noborder\">active UP "
      "</td>"
      "<td class=\"backup_up\">&nbsp;</td><td class=\"noborder\">backup UP "
      "</td>"
      "</tr><tr>\n"
      "<td class=\"active_going_down\"></td><td class=\"noborder\">active UP, "
      "going down </td>"
      "<td class=\"backup_going_down\"></td><td class=\"noborder\">backup UP, "
      "going down </td>"
      "</tr><tr>\n"
      "<td class=\"active_going_up\"></td><td class=\"noborder\">active DOWN, "
      "going up </td>"
      "<td class=\"backup_going_up\"></td><td class=\"noborder\">backup DOWN, "
      "going up </td>"
      "</tr><tr>\n"
      "<td class=\"active_down\"></td><td class=\"noborder\">active or backup "
      "DOWN &nbsp;</td>"
      "<td class=\"active_no_check\"></td><td class=\"noborder\">not checked "
      "</td>"
      "</tr><tr>\n"
      "<td class=\"maintain\"></td><td class=\"noborder\" colspan=\"3\">active "
      "or backup DOWN for maintenance (MAINT) &nbsp;</td>"
      "</tr><tr>\n"
      "<td class=\"active_draining\"></td><td class=\"noborder\" "
      ...
      (appctx->ctx.stats.flags & STAT_SHNODE)
          ? (uri->node ? uri->node : global.node)
          : "",
      (appctx->ctx.stats.flags & STAT_SHDESC) ? ": " : "",
      (appctx->ctx.stats.flags & STAT_SHDESC)
          ? (uri->desc ? uri->desc : global.desc)
          : "",
      pid, relative_pid, global.nbproc, global.nbthread, up / 86400,
      (up % 86400) / 3600, (up % 3600) / 60, (up % 60),
      global.rlimit_memmax ? ultoa(global.rlimit_memmax) : "unlimited",
      global.rlimit_memmax ? " MB" : "", global.rlimit_nofile, global.maxsock,
      global.maxconn, global.maxpipes, actconn, pipes_used,
      pipes_used + pipes_free, read_freq_ctr(&global.conn_per_sec),
      bps >= 1000000000UL
          ? (bps / 1000000000.0)
          : bps >= 1000000UL ? (bps / 1000000.0) : (bps / 1000.0),
  ...
  chunk_appendf(&trash,
                "<li><form method=\"GET\">Scope : <input value=\"%s\" "
                "name=\"" STAT_SCOPE_INPUT_NAME
                "\" size=\"8\" maxlength=\"%d\" tabindex=\"1\"/></form>\n",
  ...
  if (appctx->ctx.stats.flags & STAT_HIDE_DOWN)
    chunk_appendf(&trash, "<li><a href=\"%s%s%s%s\">Show all servers</a><br>\n",
                  uri->uri_prefix, "",
    ...
    chunk_appendf(
        &trash, "<li><a href=\"%s%s%s%s\">Hide 'DOWN' servers</a><br>\n",
        uri->uri_prefix, ";up",
        (appctx->ctx.stats.flags & STAT_NO_REFRESH) ? ";norefresh" : "",
        scope_txt);
  ...
  if (uri->refresh > 0) {
    if (appctx->ctx.stats.flags & STAT_NO_REFRESH)
      chunk_appendf(&trash, "<li><a href=\"%s%s%s%s\">Enable refresh</a><br>\n",
                    uri->uri_prefix,
  ...
  chunk_appendf(&trash, "<li><a href=\"%s%s%s%s\">Refresh now</a><br>\n",
                uri->uri_prefix,
                (appctx->ctx.stats.flags & STAT_HIDE_DOWN) ? ";up" : "",
                (appctx->ctx.stats.flags & STAT_NO_REFRESH) ? ";norefresh" : "",
                scope_txt);

  chunk_appendf(&trash, "<li><a href=\"%s;csv%s%s\">CSV export</a><br>\n",
                uri->uri_prefix, (uri->refresh > 0) ? ";norefresh" : "",
                scope_txt);

  chunk_appendf(&trash,
                "<li><a href=\"%s;json%s%s\">JSON export</a> (<a "
                "href=\"%s;json-schema\">schema</a>)<br>\n",
                uri->uri_prefix, (uri->refresh > 0) ? ";norefresh" : "",
  ...
  chunk_appendf(&trash,
                ...
                "<li><a href=\"" PRODUCT_URL_UPD "\">Updates (v" PRODUCT_BRANCH
                ")</a><br>\n"
  ...
  if (appctx->ctx.stats.st_code) {
    ...
    case STAT_STATUS_DONE:
      chunk_appendf(&trash,
                    ...
                    "<a class=lfsb href=\"%s%s%s%s\" title=\"Remove this "
                    "message\">[X]</a> "
    ...
    case STAT_STATUS_PART:
      chunk_appendf(&trash,
                    ...
                    "Some server names are probably unknown or ambiguous "
                    "(duplicated names in the backend)."
                    "</div>\n",
                    uri->uri_prefix,
                    (appctx->ctx.stats.flags & STAT_HIDE_DOWN) ? ";up" : "",
                    (appctx->ctx.stats.flags & STAT_NO_REFRESH) ? ";norefresh"
    ...
    case STAT_STATUS_ERRP:
      chunk_appendf(&trash,
                    ...
                    "<li>The backend name is probably unknown or ambiguous "
                    "(duplicated names).</li>"
                    "<li>Some server names are probably unknown or ambiguous "
                    "(duplicated names in the backend).</li>"
                    "</ul>"
                    "</div>\n",
                    uri->uri_prefix,
                    (appctx->ctx.stats.flags & STAT_HIDE_DOWN) ? ";up" : "",
    ...
    case STAT_STATUS_EXCD:
      chunk_appendf(&trash,
                    ...
                    "<a class=lfsb href=\"%s%s%s%s\" title=\"Remove this "
                    "message\">[X]</a> "
                    "<b>Action not processed : the buffer couldn't store all "
                    "the data.<br>"
    ...
    case STAT_STATUS_IVAL:
      chunk_appendf(&trash,
                    ...
                    "<a class=lfsb href=\"%s%s%s%s\" title=\"Remove this "
                    "message\">[X]</a> "
                    "<b>Invalid requests (unsupported method or chunked "
                    "encoded request).</b>"
                    "</div>\n",
                    uri->uri_prefix,
                    (appctx->ctx.stats.flags & STAT_HIDE_DOWN) ? ";up" : "",
 ...
 */
static int stats_dump_stat_to_buffer(struct stream_interface *si,
                                     struct htx *htx, struct uri_auth *uri) {
  struct appctx *appctx = __objt_appctx(si->end);
  struct channel *rep = si_ic(si);
  ...
  case STAT_ST_LIST:
    switch (domain) {
    case STATS_DOMAIN_DNS:
      if (!stats_dump_dns(si, stat_l[domain], stat_count[domain],
...
static int stats_send_http_headers(struct stream_interface *si,
  ...
  flags = (HTX_SL_F_IS_RESP | HTX_SL_F_VER_11 | HTX_SL_F_XFER_ENC |
           HTX_SL_F_XFER_LEN | HTX_SL_F_CHNK);
  sl = htx_add_stline(htx, HTX_BLK_RES_SL, flags, ist("HTTP/1.1"), ist("200"),
                      ist("OK"));
  if (!sl)
    goto full;
...
static int stats_send_http_redirect(struct stream_interface *si,
   ...
   */
  chunk_printf(&trash, "%s;st=%s%s%s%s", uri->uri_prefix,
  ...
  flags =
      (HTX_SL_F_IS_RESP | HTX_SL_F_VER_11 | HTX_SL_F_XFER_LEN | HTX_SL_F_CHNK);
  sl = htx_add_stline(htx, HTX_BLK_RES_SL, flags, ist("HTTP/1.1"), ist("303"),
                      ist("See Other"));
  if (!sl)
    goto full;
...
static void http_stats_io_handler(struct appctx *appctx) {
  ...
  if (appctx->st0 == STAT_HTTP_DONE) {
    ...
    res_htx->flags |=
        HTX_FL_EOI; /* no more data are expected. Only EOM remains to add now */
 ...
 * value) */
static int stats_dump_info_fields(struct buffer *out, const struct field *info,
                                  unsigned int flags) {
  int field;
  ...
  for (field = 0; field < INF_TOTAL_FIELDS; field++) {
    ...
    if (!stats_emit_raw_data_field(out, &info[field]))
      return 0;
    if ((flags & STAT_SHOW_FDESC) &&
        !chunk_appendf(out, ":\"%s\"", info_fields[field].desc))
      return 0;
    if (!chunk_strcat(out, "\n"))
      return 0;
  }
...
static int stats_dump_typed_info_fields(struct buffer *out,
  ...
  for (field = 0; field < INF_TOTAL_FIELDS; field++) {
    ...
    if (!chunk_appendf(out, "%d.%s.%u:", field, info_fields[field].name,
...
int stats_fill_info(struct field *info, int len) {
  ...
  if (ssl_key_rate < ssl_sess_rate) {
    ...
    ssl_reuse =
        100 - (100 * ssl_key_rate + (ssl_sess_rate - 1) / 2) / ssl_sess_rate;
  }
#endif
  ...
  chunk_appendf(out, "%ud %uh%02um%02us", up / 86400, (up % 86400) / 3600,
                (up % 3600) / 60, (up % 60));

  info[INF_UPTIME_SEC] = mkf_u32(FN_DURATION, up);
  info[INF_MEMMAX_MB] = mkf_u32(FO_CONFIG | FN_LIMIT, global.rlimit_memmax);
  info[INF_POOL_ALLOC_MB] =
      mkf_u32(0, (unsigned)(pool_total_allocated() / 1048576L));
  ...
  info[INF_SSL_BACKEND_KEY_RATE] =
      mkf_u32(FN_RATE, read_freq_ctr(&global.ssl_be_keys_per_sec));
...
#endif
  info[INF_COMPRESS_BPS_IN] =
      mkf_u32(FN_RATE, read_freq_ctr(&global.comp_bps_in));
  info[INF_COMPRESS_BPS_OUT] =
      mkf_u32(FN_RATE, read_freq_ctr(&global.comp_bps_out));
  info[INF_COMPRESS_BPS_RATE_LIM] =
      mkf_u32(FO_CONFIG | FN_LIMIT, global.comp_rate_lim);
#ifdef USE_ZLIB
  info[INF_ZLIB_MEM_USAGE] = mkf_u32(0, zlib_used_memory);
  info[INF_MAX_ZLIB_MEM_USAGE] =
      mkf_u32(FO_CONFIG | FN_LIMIT, global.maxzlibmem);
#endif
  ...
  info[INF_BUSY_POLLING] =
      mkf_u32(0, !!(global.tune.options & GTUNE_BUSY_POLLING));
  ...
  info[INF_BYTES_OUT_RATE] = mkf_u64(
      FN_RATE, (unsigned long long)read_freq_ctr(&global.out_32bps) * 32);
...
static int cli_parse_clear_counters(char **args, char *payload,
  ...
  for (px = proxies_list; px; px = px->next) {
    ...
    list_for_each_entry(li, &px->conf.listeners, by_fe) if (li->counters) {
      if (clrall)
  ...
  list_for_each_entry(mod, &stats_module_list[STATS_DOMAIN_PROXY], list) {
    ...
    for (px = proxies_list; px; px = px->next) {
      ...
      if (px->cap & PR_CAP_FE && mod_cap & STATS_PX_CAP_FE) {
        EXTRA_COUNTERS_INIT(px->extra_counters_fe, mod, mod->counters,
                            mod->counters_size);
      }

      if (px->cap & PR_CAP_BE && mod_cap & STATS_PX_CAP_BE) {
        EXTRA_COUNTERS_INIT(px->extra_counters_be, mod, mod->counters,
                            mod->counters_size);
      }

      if (mod_cap & STATS_PX_CAP_SRV) {
        for (sv = px->srv; sv; sv = sv->next) {
          EXTRA_COUNTERS_INIT(sv->extra_counters, mod, mod->counters,
                              mod->counters_size);
        }
      }
      ...
      if (mod_cap & STATS_PX_CAP_LI) {
        list_for_each_entry(li, &px->conf.listeners, by_fe) {
          EXTRA_COUNTERS_INIT(li->extra_counters, mod, mod->counters,
                              mod->counters_size);
        }
      }
    }
...
static int cli_parse_show_info(char **args, char *payload,
                               struct appctx *appctx, void *private) {
  int arg = 2;
  ...
  while (*args[arg]) {
    if (strcmp(args[arg], "typed") == 0)
      appctx->ctx.stats.flags =
          (appctx->ctx.stats.flags & ~STAT_FMT_MASK) | STAT_FMT_TYPED;
    else if (strcmp(args[arg], "json") == 0)
      appctx->ctx.stats.flags =
          (appctx->ctx.stats.flags & ~STAT_FMT_MASK) | STAT_FMT_JSON;
...
static int cli_parse_show_stat(char **args, char *payload,
                               struct appctx *appctx, void *private) {
  int arg = 2;
  ...
  if ((strm_li(si_strm(appctx->owner))->bind_conf->level & ACCESS_LVL_MASK) >=
      ACCESS_LVL_OPER)
  ...
  if (appctx->ctx.stats.domain == STATS_DOMAIN_PROXY && *args[arg] &&
...
static int
stats_allocate_proxy_counters_internal(struct extra_counters **counters,
                                       int type, int px_cap) {
  struct stats_module *mod;
...
int stats_allocate_proxy_counters(struct proxy *px) {
  ...
  if (px->cap & PR_CAP_BE) {
    if (!stats_allocate_proxy_counters_internal(&px->extra_counters_be,
                                                COUNTERS_BE, STATS_PX_CAP_BE)) {
      return 0;
    }
  }

  for (sv = px->srv; sv; sv = sv->next) {
    if (!stats_allocate_proxy_counters_internal(
            &sv->extra_counters, COUNTERS_SV, STATS_PX_CAP_SRV)) {
      return 0;
    }
  }
...
static int allocate_stats_px_postcheck(void) {
  ...
  stat_f[STATS_DOMAIN_PROXY] =
      malloc(stat_count[STATS_DOMAIN_PROXY] * sizeof(struct name_desc));
  ...
  list_for_each_entry(mod, &stats_module_list[STATS_DOMAIN_PROXY], list) {
    memcpy(stat_f[STATS_DOMAIN_PROXY] + i, mod->stats,
  ...
  stat_l[STATS_DOMAIN_PROXY] =
      malloc(stat_count[STATS_DOMAIN_PROXY] * sizeof(struct field));
...
static int allocate_stats_dns_postcheck(void) {
  ...
  stat_f[STATS_DOMAIN_DNS] =
      malloc(stat_count[STATS_DOMAIN_DNS] * sizeof(struct name_desc));
  ...
  list_for_each_entry(mod, &stats_module_list[STATS_DOMAIN_DNS], list) {
    memcpy(stat_f[STATS_DOMAIN_DNS] + i, mod->stats,
           mod->stats_count * sizeof(struct name_desc));
    i += mod->stats_count;
  }
  ...
  stat_l[STATS_DOMAIN_DNS] =
      malloc(stat_count[STATS_DOMAIN_DNS] * sizeof(struct field));
...
static struct cli_kw_list cli_kws = {
    ...
    {{{"clear", "counters", NULL},
     ...
     {{"show", "stat", NULL},
      ...
      "[desc|json|no-maint|typed|up]*",
      cli_parse_show_stat,
      cli_io_handler_dump_stat,
      NULL},
     {{"show", "schema", "json", NULL},
