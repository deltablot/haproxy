...
wurfl_handle wurfl_create(void) { return (void *)0xbeffa; }

void wurfl_destroy(wurfl_handle handle) { return; }
...
wurfl_error wurfl_add_requested_capability(wurfl_handle hwurfl,
...
int wurfl_has_virtual_capability(wurfl_handle hwurfl,
                                 const char *virtual_capability) {
  return 0;
}

wurfl_error wurfl_set_cache_provider(wurfl_handle hwurfl,
                                     wurfl_cache_provider cache_provider,
                                     const char *config) {
  return WURFL_OK;
}

wurfl_error wurfl_load(wurfl_handle hwurfl) { return WURFL_OK; }

wurfl_device_handle
wurfl_lookup(wurfl_handle hwurfl,
  ...
  const char *hvalue =
      header_retrieve_callback("User-Agent", header_retrieve_callback_data);
  // and on a non existing one
  hvalue = header_retrieve_callback("Non-Existing-Header",
                                    header_retrieve_callback_data);
  (void)hvalue;
  return (void *)0xdeffa;
}

const char *wurfl_device_get_capability(wurfl_device_handle hwurfldevice,
                                        const char *capability) {
  return "dummy_cap_val";
}

const char *
wurfl_device_get_virtual_capability(wurfl_device_handle hwurfldevice,
                                    const char *capability) {
  return "dummy_vcap_val";
}

void wurfl_device_destroy(wurfl_device_handle handle) { return; }
...
const char *
wurfl_device_get_original_useragent(wurfl_device_handle hwurfldevice) {
  return "original_useragent";
}
const char *
wurfl_device_get_normalized_useragent(wurfl_device_handle hwurfldevice) {
