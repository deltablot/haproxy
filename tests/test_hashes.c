...
static double timeval_elapsed(struct timeval *tv) {
  ...
  return (tv2.tv_sec - tv->tv_sec) + (tv2.tv_usec - tv->tv_usec) * 1.0e-6;
}
...
static unsigned long hash_djbx33(register unsigned char *key,
                                 register size_t len) {
...
int main() {
  ...
  char *urls[] = {"http://www.microsoft.com/shared/core/1/webservice/"
                  "navigation.asmx/DisplayDownlevelNavHtml",
                  NULL};
